...
const DoctorList = ({doctors, setSelectedRow,setModal,setIsAddMode, deleteDoctorById, getAllDoctors, handleChangeStatus}) => {
    const tblColumn = [{
        dataField: 'name',
        text: 'Name',
        sort: true
    ...
    const pzipcodeOptions = {
        sizePerPzipcode: 10,
        totalSize: doctors.length, // replace later with size(customers),
        custom: true
    };
    return (
