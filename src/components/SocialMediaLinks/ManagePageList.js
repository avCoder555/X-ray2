...
const SocialMediaLinkList = ({tblData, setSelectedRow,setModal,setIsAddMode, deleteById, getData, handleChangeStatus}) => {

    const tblColumn = [{
        dataField: 'socialMediaTitle',
        text: 'Social Media Title',
        sort: true
    },{
        dataField: 'url',
