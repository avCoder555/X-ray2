...
const XrayMachineList = ({tblData, setSelectedRow,setModal,setIsAddMode, deleteById, getData, handleChangeStatus}) => {

    const tblColumn = [{
        dataField: 'name',
        text: 'X-ray Machine Name',
        sort: true
    }, {
        dataField: 'status',
        text: 'Status',
...
export default XrayMachineList;
