...
const ContactUs = () => {
    ...
    const getData = () => {
        const result = contactUsServices.listApi()
            .then((res) => {
    ...
    const deleteById = async (id) => {
        const result = await contactUsServices.deleteApi({ id: id });
    ...
    const handleChangeStatus =async(id,status) =>{
        const result = await contactUsServices.updateStatusApi(id,{status:status})
        if (result.data.status === true) {
            getData()
                    ...
                    <div className="page-content">
                        <>
                            ...
                            <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                                <div className="breadcrumb-title pe-3">Contact Us</div>
                                <div className="ps-3">
